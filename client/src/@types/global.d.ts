declare module 'deck.gl' {
  ...
  class CompositeLayer<P extends LayerProps = LayerProps, S = {}> extends Layer<
    P,
    S
  > {}
  ...
  class GridCellLayer<P extends LayerProps = LayerProps, S = {}> extends Layer<
    P,
    S
  > {}

  class LineLayer<P extends LayerProps = LayerProps, S = {}> extends Layer<
    P,
    S
  > {}
  ...
  class ArcLayer<P extends LayerProps = LayerProps, S = {}> extends Layer<
    P,
    S
  > {}
...
declare module '@deck.gl/core' {
  ...
  class Layer<P extends LayerProps = LayerProps, S = {}> {
    ...
    updateState(state: { props: P; oldProps: P; changeFlags: any }): void;
  }
}
